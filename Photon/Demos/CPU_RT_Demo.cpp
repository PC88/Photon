...
void CPU_RT_Demo::run(int sw)
{
	...
	int samples_per_pixel = 100; // was 100
	...
	int image_height = 800;//= static_cast<int>(image_width / aspect_ratio);
...
color CPU_RT_Demo::ray_color(const ray& r, const color& background, const hittable& world, int depth)
{
	hit_record rec;
...
hittable_list CPU_RT_Demo::random_scene()
{
	hittable_list world;
...
hittable_list CPU_RT_Demo::two_spheres()
{
...
hittable_list CPU_RT_Demo::two_perlin_spheres()
{
	hittable_list objects;
...
hittable_list CPU_RT_Demo::earth()
{
...
hittable_list CPU_RT_Demo::simple_light()
{
	hittable_list objects;
...
hittable_list CPU_RT_Demo::cornell_box()
{
	hittable_list objects;
...
hittable_list CPU_RT_Demo::cornell_smoke()
{
	hittable_list objects;
...
hittable_list CPU_RT_Demo::final_scene()
{
